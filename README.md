# Project 3 - *Hannahgram*

**Hannahgram** is a photo sharing app using Parse as its backend.
...
- [X] Apply the Butterknife annotation library in order to reduce boilerplate code.
